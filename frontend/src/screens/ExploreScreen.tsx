		...
		const fetchExploreData = async () => {
			try {
				...
				const fetchFromCache = () => {
					...
					const cachedAnimalPosts =
						localStorage.getItem("animalPosts");
					const cachedCampingPosts =
						localStorage.getItem("campingPosts");
					const cachedPoiPosts = localStorage.getItem("poiPosts");
					const cachedSecurityPosts =
						localStorage.getItem("securityPosts");
					...
					const cachedTimestamp =
						localStorage.getItem("postsTimestamp");
					...
					return {
						...
						campingPosts: cachedCampingPosts
							...
							: null,
						poiPosts: cachedPoiPosts
							? JSON.parse(cachedPoiPosts)
							: null,
						securityPosts: cachedSecurityPosts
							? JSON.parse(cachedSecurityPosts)
							: null,
						groupPosts: cachedGroupPosts
							? JSON.parse(cachedGroupPosts)
							: null,
				...
				if (
					...
					localStorage.setItem(
						"poiPosts",
						JSON.stringify(poiData.content)
					);
					localStorage.setItem(
						"securityPosts",
					...
					localStorage.setItem(
						"groupPosts",
						JSON.stringify(groupData.content)
					);
					localStorage.setItem(
						"recommendedPosts",
