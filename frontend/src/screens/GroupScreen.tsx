...
const GroupScreen = () => {
    ...
    return (
        <div className="container mx-auto p-4 overflow-hidden"> {/* Added overflow-hidden here */}
            ...
            <ul className="flex border-b mb-4">
                ...
                <li className="mr-1"> {/* Added "Created Groups" tab */}
                    <button
                        className={`px-4 py-2 ${
            ...
            <div className="tab-content">
                ...
                {activeTab === "created-groups" && <CreatedGroupsList />}
