  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch posts count
        const postsCountResponse = await fetch(`/api/users/postsCount/${userId}`, {
          headers: {
            Accept: "application/json"
          }
        });
        ...
        // Fetch groups count
        const groupsCountResponse = await fetch(`/api/users/groupsCount/${userId}`, {
          headers: {
            Accept: "application/json"
          }
        });
        ...
        if (profilePicData.profilePic !== null) {
          localStorage.setItem("previewUrl", profilePicData.profilePic);
