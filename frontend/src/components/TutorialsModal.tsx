...
const TutorialsModal: React.FC<TutorialsModalProps> = ({ onClose }) => {
	const modalStyles = {
		...
		questionItem: "py-2 border-t border-b mb-4 cursor-pointer", // Item style remains the same
		questionTitle: "text-xl font-semibold text-black" // Ensures text is visible
	};
			...
			<div className={modalStyles.modalContent}>
				...
				<ul>
					{filteredTutorialItems.map((item, index) => (
						...
						>
							<h1 className={modalStyles.questionTitle}>
								{item.question}
							</h1>
