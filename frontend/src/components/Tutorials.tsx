...
const TutorialsPage: React.FC = () => {
  const pageStyles = {
    ...
    contentContainer: "text-content rounded-lg w-11/12 md:w-3/4 pb-16", // Add bottom padding
    ...
    image:
      "w-full sm:w-3/4 md:w-1/2 lg:w-1/3 h-auto mt-4 rounded-md border border-gray-200",
  ...
  const [tutorialItems] = useState<FaqItem[]>([
    ...
    {
      question: "How to remove a member from your group",
      image: images.remove,
      answer:
        "If you would like to remove a group member then simply click on the Remove button next to their username\nIf you realised you do not want to remove the user then click on the Cancel button\nFinally if you are sure that you want to remove the user from your group then click on the Remove button.",
    },
    {
