					...
					<div className="md:hidden flex flex-col items-center relative">
						...
						<nav className="fixed bottom-0 w-full bg-nav shadow-lg py-2 flex justify-around">
							...
							>
								<FaUser
									size={24}
									className={getIconColor("/profile")}
								/>
						...
						{/* Help Modal */}
						{showHelpCentre && (
							<HelpModal onClose={handleCloseHelpCentre} />
						)}
					</div>
							...
							<div className="flex flex-col md:flex-row items-center">
								...
								<ul className="flex ml-auto md:justify-end justify-center items-center space-x-2 md:mr-8 mt-2 md:mt-0">
									...
									<li>
										<Link
											to="/home"
											className={`flex items-center justify-center w-12 h-12 rounded-full hover:text-navBkg2 hover:bg-iconShadow transition-all duration-300 ${getIconColor(
												"/"
											)}`}
										>
											<Tooltip text="Map">
